  ...
  !(function (a, b, c, d, e) {
    ...
    function g(a, b) {
      ...
      if (b) {
        ...
        d &&
          ...
          (c =
            e === !0
              ? o.extend(a, { region_name: encodeURIComponent(d), cq: encodeURIComponent(d), intsh: 'on' })
              : o.extend(a, { userQuery: encodeURIComponent(d), cq: encodeURIComponent(d) }));
      }
      return c;
    }
    function h(a, b) {
    ...
    function i(a, b) {
      ...
      if (b) {
        ...
        d && 'string' == typeof d && '' !== o.trim(d) && (c = o.extend(a, { popupKey: d }));
      }
      return c;
    }
    function j(a, b) {
      ...
      if (b) {
        var d = b.autoClose;
        void 0 !== d && null !== d && 'boolean' == typeof d && (c = o.extend(a, { autoClose: d }));
      }
      return c;
    }
    function k(a, b) {
      ...
      if (b) {
        var d = b.popupTitle;
        d && 'string' == typeof d && '' !== o.trim(d) && (c = o.extend(a, { popupTitle: d }));
      }
      return c;
    }
    function l(a) {
      ...
      if (
        ...
        c.onComplete && 'function' == typeof c.onComplete && c.onComplete !== p.EMPTY_FUNCTION
          ? (c.onComplete = c.onComplete)
          : c.oncomplete && 'function' == typeof c.oncomplete && c.oncomplete !== p.EMPTY_FUNCTION
          ? (c.onComplete = c.oncomplete)
          : ((c.onComplete = p.EMPTY_FUNCTION), (c.oncomplete = p.EMPTY_FUNCTION), (c.isViewerMode = !0)),
        c.onResize && 'function' == typeof c.onResize && c.onResize !== p.EMPTY_FUNCTION
          ? (c.onResize = c.onResize)
          : c.onresize && 'function' == typeof c.onresize && c.onresize !== p.EMPTY_FUNCTION
          ? (c.onResize = c.onresize)
          : ((c.onResize = p.EMPTY_FUNCTION), (c.onresize = p.EMPTY_FUNCTION)),
        c.onClose && 'function' == typeof c.onClose && c.onClose !== p.EMPTY_FUNCTION
          ? (c.onClose = c.onClose)
          : c.onclose && 'function' == typeof c.onclose && c.onclose !== p.EMPTY_FUNCTION
          ? (c.onClose = c.onclose)
          : ((c.onClose = p.EMPTY_FUNCTION), (c.onclose = p.EMPTY_FUNCTION)),
        c.onSearch && 'function' == typeof c.onSearch && c.onSearch !== p.EMPTY_FUNCTION
          ? (c.onSearch = c.onSearch)
          : c.onsearch && 'function' == typeof c.onsearch && c.onsearch !== p.EMPTY_FUNCTION
          ? (c.onSearch = c.onsearch)
          : ((c.onSearch = p.EMPTY_FUNCTION), (c.onsearch = p.EMPTY_FUNCTION)),
    ...
    if (!m)
      return void alert(
        '[ìš°íŽ¸ë²ˆí˜¸ ì„œë¹„ìŠ¤] API ë¡œë”© ì˜¤ë¥˜ê°€ ë°œìƒí•˜ì˜€ìŠµë‹ˆë‹¤. í™•ì¸ ë°”ëžë‹ˆë‹¤. ì§€ì†ì ì¸ ì˜¤ë¥˜ ë°œìƒì‹œ ( https://github.com/daumPostcode/QnA/issues ) ì´ìŠˆ ë“±ë¡ ë¶€íƒë“œë¦½ë‹ˆë‹¤.'
      );
    var n = (function (a) {
    ...
    n(
      !0,
      '[ìš°íŽ¸ë²ˆí˜¸ ì„œë¹„ìŠ¤ ë¡œë”© ì˜¤ë¥˜] API ë¡œë”©ì‹œ í—ˆìš©ë˜ì§€ ì•ŠëŠ” íŒŒë¼ë¯¸í„°ê°€ ê°ì§€ë˜ì—ˆìŠµë‹ˆë‹¤. ì‚¬ì´íŠ¸ ê´€ë¦¬ìž(ê°œë°œìž)ë¶„ê»˜ì„œëŠ” ê°€ì´ë“œíŽ˜ì´ì§€( https://postcode.map.daum.net/guide )ì˜ ê¸°ë³¸ ì‚¬ìš©ë²•ì„ ì°¸ê³ í•˜ì‹œì–´ ìˆ˜ì • ë¶€íƒë“œë¦½ë‹ˆë‹¤.'
    );
    var o = b,
      p = a.CONT,
      q = a.MODEL,
      ...
      (l.prototype = {
        open: function (a) {
          if (
            !n(
              !1,
              '[ìš°íŽ¸ë²ˆí˜¸ ì„œë¹„ìŠ¤] API ë¡œë”©ì‹œ í—ˆìš©ë˜ì§€ ì•Šì€ íŒŒë¼ë¯¸í„°ê°€ ê°ì§€ë˜ì–´ API ìž‘ë™ì´ ì¤‘ì§€ë˜ì—ˆìŠµë‹ˆë‹¤. ì‚¬ì´íŠ¸ ê´€ë¦¬ìžë¶„ê»˜ì„œëŠ” ê°€ì´ë“œíŽ˜ì´ì§€( https://postcode.map.daum.net/guide )ì˜ ê¸°ë³¸ ì‚¬ìš©ë²•ì„ ì°¸ê³ í•˜ì‹œì–´ ìˆ˜ì • ë¶€íƒë“œë¦½ë‹ˆë‹¤.'
            )
          ) {
        ...
        embed: function (a, b) {
          if (
            ...
            (c = g(c, b)), (c = j(c, b)), (c = o.extend(c, { viewType: 'layer' })), s.layer.create(c, a);
          }
        },
      }),
      (c.daum.Postcode = l);
